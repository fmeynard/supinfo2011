...
/**
 * CommunityComment form base class.
 *
 * @method CommunityComment getObject() Returns the current form's model object
 *
 * @package    d
 * @subpackage form
 ...
 */
abstract class BaseCommunityCommentForm extends BaseFormDoctrine
{
