...
/**
 * Frm_Post filter form base class.
 *
 * @package    d
 * @subpackage filter
 ...
 */
abstract class BaseFrm_PostFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'topic_id'    => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Frm_Topic'), 'column' => 'id')),
