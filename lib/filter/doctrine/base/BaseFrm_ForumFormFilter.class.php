...
/**
 * Frm_Forum filter form base class.
 *
 * @package    d
 * @subpackage filter
 ...
 */
abstract class BaseFrm_ForumFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'category_id'    => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Frm_Category'), 'column' => 'id')),
      'latest_post_id' => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Frm_Post'), 'column' => 'id')),
