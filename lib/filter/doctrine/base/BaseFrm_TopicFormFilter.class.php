...
/**
 * Frm_Topic filter form base class.
 *
 * @package    d
 * @subpackage filter
 ...
 */
abstract class BaseFrm_TopicFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'forum_id'       => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('Frm_Forum'), 'column' => 'id')),
