...
<h1 class="afterSub"><?php echo __('Teachers'); ?></h1>
...
(
  {
    url: "<?php echo url_for('user/loadTeachers?id='.$agency->getId()); ?>",
    dataType: 'json',
    colModel : [
    ...
    sortorder : "asc",
    usepager : true,
    title : '<?php echo __('Teachers list'); ?>',
    useRp : true,
    rp : 10,
...
function addFct(com)
{
 window.location.replace("<?php echo url_for('user/newTeacher?slug='.$agency->getSlug()); ?>"); 
}
