<div id="subMenu">
  <ul>
    ...
    <li><?php echo link_to(__('Formation Centers'),'agency/listAgencyRoom?slug='.$form->getObject()->getAgency()->getSlug()); ?></li>
...
<div id="sf_admin_content">
  <div class="sf_admin_form">
    <form method="post" action="<?php echo url_for('agency/updateAgencyRoom?id='.$form->getObject()->getId()); ?>">
    <fieldset>
      <?php echo $form; ?>
    </fieldset>
