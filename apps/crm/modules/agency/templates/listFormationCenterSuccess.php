...
(
  {
    url: "<?php echo url_for('agency/loadFormationCenter?slug='.$agency->getSlug()); ?>",
    dataType: 'json',
    colModel : [
...
function addFct(com)
{
 window.location.replace("<?php echo url_for('agency/newFormationCenter?slug='.$agency->getSlug()); ?>"); 
}
