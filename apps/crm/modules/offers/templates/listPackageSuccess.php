...
(
  {
    url: "<?php echo url_for('offers/loadPackage'); ?>",
    dataType: 'json',
    colModel : [
    ...
    sortorder : "asc",
    usepager : true,
    title : '<?php echo __('Packages list'); ?>',
    useRp : true,
    rp : 10,
...
function test(com)
{
  window.location.replace("<?php echo url_for('offers/newPackage'); ?>"); 
}
</script>