...
(
  {
    url: "<?php echo url_for('agencyRoom/loadAgencyRoom?slug='.$agency->getSlug()); ?>",
    dataType: 'json',
    colModel : [
...
function addFct(com)
{
 window.location.replace("<?php echo url_for('agencyRoom/newAgencyRoom?slug='.$agency->getSlug()); ?>"); 
}
